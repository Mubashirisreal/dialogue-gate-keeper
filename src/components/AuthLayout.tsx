...
export function AuthLayout({ children, logoSrc, appName = "Dialogue Gatekeeper" }: AuthLayoutProps) {
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-b from-accent to-background p-4 sm:p-8">
